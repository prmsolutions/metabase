...
(defmethod sql-jdbc.execute/execute-sql! :sqlite [driver context dbdef sql]
...
(let [load-data! (load-data/make-load-data-fn load-data-stringify-dates load-data/load-data-chunked)]
  (defmethod load-data/load-data! :sqlite [driver dbdef tabledef]
    (load-data! driver dbdef tabledef)))

(defmethod sql.tx/drop-db-if-exists-sql :sqlite [_ _] nil)

(defmethod sql.tx/create-db-sql :sqlite [_ _] nil)

;; TODO - fix me
(defmethod sql.tx/add-fk-sql :sqlite [_ _ _ _] nil)
