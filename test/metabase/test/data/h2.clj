...
(defmethod ddl/drop-db-ddl-statements :h2 [& _] nil)

(defmethod ddl/create-db-ddl-statements :h2 [& _]
...
(defmethod execute/execute-sql! :h2 [_ _ dbdef sql]
  ...
  ;; tables / etc)
  (execute/execute-sql! :sql-jdbx/test-extensions :server dbdef sql))
