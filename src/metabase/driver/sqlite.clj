...
(defmethod driver/supports? [:sqlite :case-sensitivity-string-filter-options] [_] false)

;; SQLite doesn't have a standard deviation function
(defmethod driver/supports? [:sqlite :standard-deviation-aggregations] [_] false)
...
(defmethod driver/supports? [:sqlite :foreign-keys] [_] (not config/is-test?))
