...
(defmethod sql.qp/date [:oracle :day-of-week]     [_ _ v] (hx/inc (hx/- (date :day v)
                                                                        (date :week v))))

(defmethod sql.qp/date [:oracle :day-of-month]    [_ _ v] (hsql/call :extract :day v))
(defmethod sql.qp/date [:oracle :day-of-year]     [_ _ v] (hx/inc (hx/- (date :day v) (trunc :year v))))
...
(defmethod sql.qp/date [:oracle :week-of-year]    [_ _ v] (hx/inc (hx// (hx/- (trunc :iw v)
                                                                         (trunc :iy v))
                                                                   7)))
...
(defmethod sql.qp/date [:oracle :quarter-of-year] [_ _ v] (hx// (hx/+ (date :month-of-year (date :quarter v))
                                                                 2)
                                                           3))
