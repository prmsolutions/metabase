...
(defmethod driver/supports? [:mongo :basic-aggregations] [_] true)
(defmethod driver/supports? [:mongo :nested-fields]      [_] true)
...
(defmethod driver/mbql->native [_ query]
  (qp/mbql->native query))

(defmethod driver/execute-query [_ query]
